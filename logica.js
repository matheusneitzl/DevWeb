const cores = new Array ("AliceBlue", "AntiqueWhite", "Aqua", "Aquamarine", "Azure", "Beige", "Bisque", "Black", "BlanchedAlmond", "Blue", "BlueViolet", 
...
function continuacao() {
    ...
    do {
        var mensagem = "Digite uma das cores informada: \n\n";
